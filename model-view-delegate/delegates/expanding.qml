...
Item {
    ...
    // informações dos elementos da lista
    ListModel {
        id: planets
    ...
    Component {
        ...
        Item {
            ...
            // ao clicar no item muda o estado o objeto
            MouseArea {
                anchors.fill: parent
            ...
            Item {
                ...
                // antes de clicar não mostra nada
                opacity: 0
            ...
            // botão de fechar a tela de detalhes
            Rectangle {
                id: closeButton
                anchors.right: parent.right
                anchors.top: parent.top
                ...
                // color: "#157efb"
                color: Qt.lighter(wrapperBorder.color, 2)
                ...
                // ao clicar volta para o estado original
                MouseArea {
                    anchors.fill: parent
